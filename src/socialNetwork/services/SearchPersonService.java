...
public class SearchPersonService {
    ...
    public void showPersons(String login) {
        ...
        JFrame mainFrame = new JFrame("Пользователи");
        ...
        // Заголовок
        JLabel titleLabel = new JLabel("Все пользователи");
    ...
    private JPanel createUserRow(Person user, Person currentUser, UserStorage storage) {
        ...
        // Кнопка "Добавить в друзья" или "В друзьях"
